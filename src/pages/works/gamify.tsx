...
const Gamify: NextPage = () => {
  return (
    <div>
      ...
      <Layout>
        <main>
          <div className="antialiased font-mono"> <a href="/works"><span className="hover:underline">Works</span></a> > <span className="font-bold">Gamify</span></div>
          <div className="flex flex-col pt-12">
            <div className="text-antiliased">
              <span className="font-cursive text-[32px] text-punk-blue">Gamify</span>
              <ul className="pt-8">
                <li className="mt-2">Website: https://Gamify.com</li>
